...
import net.ben.neatmobsmod.entity.model.ZomboEntityModel;
...
public class NEATMobsModClient implements ClientModInitializer {
    public static final EntityModelLayer MODEL_ZOMBO_LAYER = new EntityModelLayer(new Identifier(NEATMobsMod.MOD_ID, "zombo"), "main");

    /*
    initialises gamerule, boolean variables that can be changed
